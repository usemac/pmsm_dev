...
%                 
        % CONTROL DE CORRIENTE FCS-MPC (horizonte k+1)
        ...
        var_contr_ioptimo = 0;
        var_opt_fdq = var_contr_fdq;
        for vv=1:param_NV
            % Tensión dq
            var_contr_vfase = param_vdc*param_T*XI8(vv,:)';
            var_opt_vdq = param_Mtransf*var_contr_vfase;
            % Flujos en k+1
            var_contr_fdq_p1p = var_opt_fdq + cte_contr_Tm_FSMPC*(var_opt_vdq(1:2) - R_s*var_contr_idq_real + omegae*[0 -1;1 0]*var_opt_fdq);
            % Corrientes en k+1
            ...
            var_contr_idq_errc2p = var_contr_idq_refe'-var_contr_idq_p1p;
    ...
    % Flujos en h+1
    var_sim_fdq = var_sim_fdq + param_sim_h*(var_contr_vdq_opt - R_s*var_sim_x + omegae*[0 -1;1 0]*var_sim_fdq);
