...
%                 
        ...
        var_contr_fdq = var_contr_fdq_p1p;
        ...
        var_contr_idq_p1p(2) = interpn(data.phi_d,data.phi_q',data.theta,data.i_q,var_contr_fdq_p1p(1),var_contr_fdq_p1p(2),var_contr_thetar_deg,method);
        ...
        for vv=1:param_NV
            ...
            % Flujos en k+2
            var_contr_fdq_p2p = var_contr_fdq_p1p + cte_contr_Tm_FSMPC*(var_opt_vdq(1:2) - R_s*var_contr_idq_p1p + omegae*[0 -1;1 0]*var_contr_fdq_p1p);
            % Corrientes en k+1
            ...
            var_contr_idq_p2p(2) = interpn(data.phi_d,data.phi_q',data.theta,data.i_q,var_contr_fdq_p2p(1),var_contr_fdq_p2p(2),var_contr_thetar_degk2,method);
            ...
            if var_contr_J < var_contr_Joptimo
                ...
                var_contr_vdq_opt = var_opt_vdq(1:2);
            end
        end
        ...
        tray_contr_thetar_deg(var_contr_contadorPM+1,:) = var_contr_thetar_deg;
    end
